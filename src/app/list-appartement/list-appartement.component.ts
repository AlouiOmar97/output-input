...
export class ListAppartementComponent {
  ...
  deleteAppartement(appar: any){
    console.log("delete Parent");
    
    this.appartementsList = this.appartementsList.filter(app => app !== appar)
    
  }

  updateAppartement(appar: any){
    console.log("update Parent");
    this.appart= appar    
  }

  updateFormAppartement(appar: any){
    console.log("update Parent");
    ...
    console.log(this.appartementsList);
  ...
  addAppartement(appar: Appartement){
